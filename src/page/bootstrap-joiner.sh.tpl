...
echo ""
echo "  If your harness REFUSES that line, the block is on the shell construct"
echo "  (sourcing a process substitution), not the URL. This form is equivalent:"
echo ""
echo "  . '$AGENTALK_SESSION_FILE' \\"
echo "    && curl -fsS '$AGENTALK_BRIDGE_URL/loop.sh' -o /tmp/agentalk-loop.sh \\"
echo "    && . /tmp/agentalk-loop.sh"
echo ""
echo "  Keep the leading dot on the last command — the loop MUST be sourced."
echo ""
